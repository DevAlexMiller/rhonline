...
function ResetPassword() {
    ...
    const API_URL_RESET = 'http://10.92.11.254:3000/api/users/reset-password'; // Rota para resetar (POST)
    ...
    const handleRedefinir = async (cpf) => {
        ...
        try {
            ...
            if (response.data.success) {
                ...
                setStatusMessage(`✅ Senha de ${cpf} redefinida para: ${newPass}`);
            } else {
    ...
    useEffect(() => {
        async function fetchUsers() {
            ...
            try {
                ...
                // Assumindo que a rota /usuarios retorna um array de objetos:
    ...
    const dadosComAcao = users.map((u) => ({
        'Código': u['cpf'] || u['Código'], // Usa 'cpf' ou 'Código' dependendo da chave do backend
        'Nome': u['Nome'] || 'N/A', 
        'CPF': u['cpf'], 
        'Redefinir': (
            <button
